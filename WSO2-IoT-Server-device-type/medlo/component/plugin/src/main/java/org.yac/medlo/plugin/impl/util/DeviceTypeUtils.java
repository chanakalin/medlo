...
package org.yac.medlo.plugin.impl.util;
...
/**
 * Contains utility methods used by medlonode plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.yac.medlo.plugin.impl.util.DeviceTypeUtils.class);
