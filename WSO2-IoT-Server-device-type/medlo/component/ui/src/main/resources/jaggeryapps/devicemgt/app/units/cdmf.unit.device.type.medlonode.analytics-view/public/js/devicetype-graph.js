...
var sensorType3 = "uvindex";
var sensorType4 = "visiblelight";
var sensorType1Graph;
var sensorType2Graph;
var sensorType3Graph;
var sensorType4Graph;

function drawGraph_medlonode(from, to)
{
    ...
    $("#sensorType3yAxis").html("");
    $("#smoother").html("");
    $("#sensorType3Legend").html("");
    $("#chartSensorType3").html("");
    $("#sensorType3xAxis").html("");
    $("#sensorType3Slider").html("");

    $("#sensorType4yAxis").html("");
    $("#smoother").html("");
    $("#sensorType4Legend").html("");
    $("#chartSensorType4").html("");
    $("#sensorType4xAxis").html("");
    $("#sensorType4Slider").html("");
